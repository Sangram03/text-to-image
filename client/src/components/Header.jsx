...
const Header = () => {
  ...
  return (
    ...
    >
      ...
      >Unplash your creativity with AI. Turn your imagination into visual art in seconds - just type , and watch the magic happen.</motion.p>
      ...
      >Generate Images 
        ...
        transition={{delay:1.2 , duration:0.8}}
         className='mt-2 text-neutral-600'>Genrated images from photofy</motion.p>
    </motion.div>
  );
}
